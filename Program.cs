        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Task.Run(() =>
                {
                    ...
                    output.Close();
                    Log("IP:" + request.RemoteEndPoint.Address.ToString() + "请求查询" + ip + ":" + port);
                });
            }
        }
        static void Log(string str)
        {
            string msg = string.Format("[{0} {1} INFO] {2}", DateTime.Now.ToShortDateString(), DateTime.Now.ToLongTimeString(), str);
